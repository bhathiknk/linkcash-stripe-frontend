...
function PaymentFlowOneTime() {
    ...
    const fetchPaymentDetails = async (linkId) => {
        try {
            const apiUrl = `http://localhost:8080/api/one-time-payment-links/link/${linkId}/details`;
            ...
            console.log('Fetched One-Time Payment Details:', data);
    ...
    useEffect(() => {
        if (paymentDetails && !clientSecret) {
            ...
            fetchClientSecret('oneTime', payload);
        }
...
export default PaymentFlowOneTime;
